...
def findEllipticalPoint2(centerx, centery, cxs, cys, rad1, rad2, color1, r1val, r2val):
    ...
    showing_withalldiag(centerx, centery, cxs, cys, rad1,
                        rad2, list_xCoordinate, list_yCoordinate, color1)
...
def main():
    ...
    findEllipticalPoint2(centerx, centery, centerxS, centeryS,
                         radius1, radius2, 'Red', r1_red, r2_red)
    findEllipticalPoint2(centerx, centery, centerxS, centeryS,
                         radius1, radius2, 'Green', r1_green, r2_green)
    findEllipticalPoint2(centerx, centery, centerxS, centeryS,
                         radius1, radius2, 'Blue', r1_blue, r2_blue)
